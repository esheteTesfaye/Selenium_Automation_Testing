...
public class getValueFromCalculaterTextBox_Two {

	
	
	// Now let us try to Implement test classes parallel execution practically.
   // TestNG has very good feature to execute test cases/classes In parallel to each other 
	//means you can execute two different test cases In two different windows of same browser simultaneously
