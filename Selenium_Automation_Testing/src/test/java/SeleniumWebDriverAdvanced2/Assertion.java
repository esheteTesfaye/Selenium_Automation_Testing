package SeleniumWebDriverAdvanced2;
	...
	*/
	...
	// assertions at element level using isDisplayed, isEnabled and isSelected
	...
	// we use isSelected to for check box, combobox and list box to assure that the specified element is selected or not
