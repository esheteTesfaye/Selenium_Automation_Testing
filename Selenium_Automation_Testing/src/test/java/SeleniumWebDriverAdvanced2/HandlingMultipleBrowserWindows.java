...
public class HandlingMultipleBrowserWindows {
		...
		WebDriver driver = null;
		 ...
		 public void beforetest() {
			 System.setProperty("webdriver.gecko.driver", utility.DriverPath.chromeDriver);
		...
		@Test
		  ...
		  driver.findElement(By.xpath("//b[contains(.,'Open New Page')]")).click();// i did not understand this
